...
$string['apiidentifier_desc'] = "The identifier field to use when making a call to the Zoom API. The selected field must be unique for each user and must not be editable by users; otherwise a user could impersonate another user's Zoom account and obtain host access to their meetings.";
...
$string['err_password'] = 'Passcode may only contain the following characters: array(a-z A-Z 0-9 @ - _ *). Max of 10 characters.';
...
$string['password_allowed_char'] = 'Passcode may only contain the following characters: array(a-z A-Z 0-9 @ - _ *).';
...
$string['privacy:metadata:zoom:lastname'] = "The user's last name is sent when their Zoom account is provisioned automatically.";
